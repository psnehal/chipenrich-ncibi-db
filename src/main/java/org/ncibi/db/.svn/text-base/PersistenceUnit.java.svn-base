...
public final class PersistenceUnit implements PersistenceSession
{
    ...
    {
    	System.out.println("1"+persistenceUnit);
        ...
        System.out.println("2"+session.getStatistics());
    }
    ...
    {
    	System.out.println("In persistent Unit");
        this.entityManager = entityManager;
        final Session session = (Session) entityManager.getDelegate();
        this.sessionFactory = session.getSessionFactory();
       // System.out.println("3"+sessionFactory.getCurrentSession());
    }
    ...
    {
    	//System.out.println("inside SessionFactory open session");
    ...
    private static abstract class FluentQueryImpl implements FluentQuery
    {
        ...
        public FluentQueryImpl(final String query, final boolean isSql)
        {
            ...
            System.out.println("****************************"+" inside FluentQueryImplLast "+query+isSql);
        }
        ...
        {
            this.isSql = isSql;
            System.out.println("Inside setupQueryType \n query and issql : = "+query+ "   "+isSql);
            if (isSql)
            {
    ...
    {
    	System.out.println("inside hqlQuery \n"+ query);
    ...
    {
    	System.out.println("inside hqlQuery*************"+session.toString());
    ...
    public FluentQuery hqlQuery(final Session session, final String queryName, List<QueryProperty> qpList)
    {
        ...
        System.out.println("4"+session.getStatistics()+"\n"+q.getQueryString());
        if (qpList != null)
        {
        ...
        System.out.println("5"+session.getStatistics()+"\n"+q.getQueryString());
        return fluentQuery;
    }
    ...
    public FluentQuery sqlQuery(final Session session,  final String queryName, List<QueryProperty> qpList)
    {
        ...
        if (qpList != null)
        {
            ...
            System.out.println("7"+queryName);
        }
        ...
        System.out.println("8"+queryName);
        return fluentQuery;
    }
